...
select * from `factinternetsales csv`;
desc `factinternetsales csv`;
alter table `FactInternetSales csv`
...
alter table `factinternetsales csv` add Orderdate_new date;
update `factinternetsales csv` set Orderdate_new= date_add('1899-12-30', interval OrderDate day);
alter table `factinternetsales csv` drop column OrderDate;
alter table `factinternetsales csv` add Duedate_new date;
update `factinternetsales csv` set Duedate_new= date_add('1899-12-30', interval DueDate day);
alter table `factinternetsales csv` drop column DueDate;
alter table `factinternetsales csv` add Shipdate_new date;
update `factinternetsales csv` set Shipdate_new= date_add('1899-12-30', interval ShipDate day);
alter table `factinternetsales csv` drop column ShipDate;
select * from `factinternetsales csv`;
...
change `Unit price` UnitPrice text;
